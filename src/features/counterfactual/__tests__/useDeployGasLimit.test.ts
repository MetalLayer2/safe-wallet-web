...
import * as protocolKit from '@metalblockchain/safe-protocol-kit'
import * as protocolKitContracts from '@metalblockchain/safe-protocol-kit/dist/src/contracts/safeDeploymentContracts'
...
} from '@metalblockchain/safe-protocol-kit/dist/src/types'
