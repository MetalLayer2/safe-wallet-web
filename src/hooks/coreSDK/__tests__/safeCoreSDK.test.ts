...
import {
  ...
  getSafeContract,
} from '@metalblockchain/safe-protocol-kit/dist/src/contracts/safeDeploymentContracts'
...
jest.mock('@metalblockchain/safe-protocol-kit/dist/src/contracts/safeDeploymentContracts')
...
jest.mock('@metalblockchain/safe-protocol-kit', () => {
  return {
    ...jest.requireActual('@metalblockchain/safe-protocol-kit'),
    __esModule: true,
    default: {
      init: jest.fn(),
    },
